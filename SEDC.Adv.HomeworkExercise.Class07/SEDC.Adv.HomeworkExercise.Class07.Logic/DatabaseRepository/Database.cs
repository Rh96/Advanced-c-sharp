...
namespace SEDC.Adv.HomeworkExercise.Class07.Logic.DatabaseRepository
{
    public static class Database
    {
		public static List<Dog> dogs = new List<Dog>()
		{
			...
			new Dog("Trixie", "White", 8, Race.Pointer), // 19 white
		};
